...
function printHelp () {
  ...
  echo "    -c <channel name> - test network channel name (defaults to \"bcereconchannel\")"
  ...
  echo "	addOrg3.sh up"
  echo "	addOrg3.sh up -c bcereconchannel -s couchdb"
...
#default for delay
CLI_DELAY=3
# channel name defaults to "bcereconchannel"
CHANNEL_NAME="bcereconchannel"
